...
<html>
    <head>
        <link rel="stylesheet" href="styles-top-player.css" />
    ...
    <body>
        ...
        <div class="abilities">TEAMMATES</div>

        <div class="skills-container">
            <img
                    class="skill"
                    src="<%= request.getAttribute("team1") %>"
            />
            <img
                    class="skill"
                    src="<%= request.getAttribute("team2") %>"
            />
            <img
                    class="skill"
                    src="<%= request.getAttribute("team3") %>"
            />
            <img
                    class="skill"
                    src="<%= request.getAttribute("team4") %>"
            />
        </div>
        <footer>
